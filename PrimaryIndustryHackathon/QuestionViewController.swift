...
class QuestionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        selectBtn0.setImage(UIImage(named:"startBG"), for: UIControlState.normal)
        ...
        selectBtn1.setImage(UIImage(named:"startBG"), for: UIControlState.normal)
        ...
        selectBtn2.setImage(UIImage(named:"startBG"), for: UIControlState.normal)
        ...
        selectBtn3.setImage(UIImage(named:"startBG"), for: UIControlState.normal)
