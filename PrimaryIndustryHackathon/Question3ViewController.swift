...
class Question3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        selectBtn0.setImage(UIImage(named:"9.jpg"), for: UIControlState.normal)
        ...
        selectBtn1.setImage(UIImage(named:"10.jpg"), for: UIControlState.normal)
        ...
        selectBtn2.setImage(UIImage(named:"11.jpg"), for: UIControlState.normal)
        ...
        selectBtn3.setImage(UIImage(named:"12.jpg"), for: UIControlState.normal)
    ...
    internal func basicButtonClicked(sender: UIButton){
        ...
        let questionVC:ResultViewController = ResultViewController()
