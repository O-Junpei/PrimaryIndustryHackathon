...
class Question1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        selectBtn0.setImage(UIImage(named:"1.jpg"), for: UIControlState.normal)
        ...
        selectBtn1.setImage(UIImage(named:"2.jpg"), for: UIControlState.normal)
        ...
        selectBtn2.setImage(UIImage(named:"3.jpg"), for: UIControlState.normal)
        ...
        selectBtn3.setImage(UIImage(named:"4.jpg"), for: UIControlState.normal)
    ...
    internal func basicButtonClicked(sender: UIButton){
        ...
        let questionVC:Question2ViewController = Question2ViewController()
